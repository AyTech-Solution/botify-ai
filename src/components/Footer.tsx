        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-lg font-bold text-gray-900 tracking-tight">Botify AI</span>
            </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/aytech_solution" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-indigo-600 transition-colors"><Instagram className="w-5 h-5" /></a>
            </div>
          </div>
        </div>
