...
export default function PremiumPage() {
  ...
  const handlePayment = () => {
    ...
    const note = isTrial ? "Botify AI 15-Day Trial" : "Botify AI Monthly Subscription";
    const planName = isTrial ? 'Trial' : 'Premium';
    
    // UPI Deep Link
    const upiUrl = `upi://pay?pa=${UPI_ID}&pn=Botify%20AI&am=${amount}&cu=INR&tn=${encodeURIComponent(note)}`;
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-500 max-w-2xl mx-auto font-medium leading-relaxed">
            Join 2,000+ businesses using Botify AI Premium to automate their customer service and scale faster.
          </p>
        </div>
