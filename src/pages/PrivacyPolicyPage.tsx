        ...
        <div className="prose prose-indigo max-w-none space-y-12">
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              At Botify AI, we take your privacy seriously. This policy explains how we collect, use, and protect your personal information and the data your AI bots process. By using our service, you agree to the practices described in this policy.
            </p>
          </section>
