  ...
  const handleAuth = async (e: React.FormEvent) => {
    ...
    try {
      if (isLogin) {
        ...
        speak(`Welcome back! Logging you in to your Botify AI dashboard.`);
        ...
        speak(`Account created successfully! Welcome to the Botify AI family, ${displayName}. Please verify your email to continue.`);
