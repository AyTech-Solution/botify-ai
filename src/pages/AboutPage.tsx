      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center max-w-3xl mx-auto">
            ...
            >
              We believe every business, regardless of size, should have access to world-class AI technology. Botify AI was built to make bot creation as simple as writing a text.
            </motion.p>
          </div>
        </div>
      </section>
