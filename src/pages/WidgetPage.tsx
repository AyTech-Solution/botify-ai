...
export default function WidgetPage() {
  ...
  const toggleListening = () => {
    ...
    recognition.lang = (bot?.primaryLanguage === 'auto' || !bot?.primaryLanguage) ? 'en-US' : bot.primaryLanguage;
      ...
      <div className="p-4 bg-white border-t border-gray-100 shrink-0">
        ...
        <div className="mt-2 text-center">
          <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest flex items-center justify-center">
            Powered by <Sparkles className="w-3 h-3 mx-1 text-indigo-400" /> Botify AI
          </p>
        </div>
      </div>
    </div>
